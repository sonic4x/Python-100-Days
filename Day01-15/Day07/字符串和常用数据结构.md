...
def main():
    ...
    print(set1 - set2)      # print(set1.difference(set2))   -show what in set1 but not in set2
...
def main():
    ...
    scores['白元芳'] = 65
    scores['诸葛王朗'] = 71
    scores.update(冷面=67, 方启鹤=85)    # Note there is no ""
    print(scores)
    if '武则天' in scores:
        print(scores['武则天'])
    ...
    # 删除字典中的元素
    print(scores.popitem())             # pop from right to left
    print(scores.popitem()) 
    print(scores.pop('骆昊', 100))      # pop the specific key, if key is not exist, return the default value    
    # 清空字典
    scores.clear()
    print(scores)
